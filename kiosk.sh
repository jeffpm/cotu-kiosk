...
/usr/bin/chromium-browser --kiosk --enable-kiosk-mode --noerrdialogs --disable-infobars --disable-ipv6 --allow-file-access-from-files --disable-java --disable-restore-session-state --disable-sync --disable-translate --disk-cache-size=1 --media-cache-size=1 file:///home/dan/cotu-kiosk/cotu-pinball.jp https://insider.sternpinball.com/kiosk/fpdgr-PeKmG-mQW &
